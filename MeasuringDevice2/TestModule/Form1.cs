    ...
    public partial class Form1 : Form
    {
        ...
        private void buttonStart_Click(object sender, EventArgs e)
        {
            ...
            if (device == null)
            {
                ...
                device = new MeasureMassDevice(Units.Metric, "Logs.txt", 2000);
            ...
            {
                labelHeartBeat.Text = args?.TimeStamp.ToString();
            };
        ...
        private void device_NewMeashurementTaken(object sender, EventArgs e)
        {
            if (device != null)
            {
                //textBoxOutput.Text = device.MostRecentMeasure.ToString();
